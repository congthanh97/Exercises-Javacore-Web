...
public class NewServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<News> all = newModel.getAllPage(page);
            int rowsCount = newModel.count();
            int pages = (int) Math.ceil(rowsCount / newModel.ROW_PER_PAGE);
            request.setAttribute("news", all);
            request.setAttribute("current", page);
            request.setAttribute("total", pages);

//            List<News> news = newModel.getNews();
